...
$(document).ready(function () {
    ...
    $(".layout-type > a").on("click", function () {
        ...
        if (a == "dark") {
            ...
            $.cookie('layout-css', THEME_URL +"/media/css//media/css/layout-dark.css", { expires: 7 });
        } else {
            $("#layout-css").attr("href","");
    ...
    $("#theme-rtl").change(function () {
        $("#rtl-css").attr("href","");
        if ($(this).is(":checked")) {
            $("#rtl-css").attr("href","/media/css/layout-rtl.css");
        } else {
            $("#rtl-css").attr("href", "")
        }
    });
    ...
    $("#blur-layouts").change(function () {
        if ($(this).is(":checked")) {
            $("#layout-blur-css").attr("href", THEME_URL +"/media/css/layout-blur-css.css");
            $.cookie('layout-blur-css', THEME_URL +"/media/css/layout-blur-css.css", { expires: 7 });
        } else {
